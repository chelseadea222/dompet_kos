...
<head>
    ...
    <style>
        ...
        .app-container {
            ...
            position: relative; box-shadow: 0 0 20px rgba(0,0,0,0.15);
...
<div class="app-container font-sans">
    ...
    <div class="flex-grow flex flex-col items-center justify-center p-8 relative z-10 mt-8">
        ...
        <div class="w-48 h-48 bg-white/20 p-3 rounded-[2rem] shadow-2xl backdrop-blur-md mb-8 border border-white/40 float-anim">
    ...
    <div class="p-8 pb-12 w-full relative z-10 flex flex-col gap-4 bg-white/20 backdrop-blur-lg rounded-t-[40px] border-t border-white/40 shadow-[0_-15px_30px_rgba(0,0,0,0.1)]">
        ...
        <a href="register.php" class="w-full bg-white text-[#2a40a3] py-4 rounded-2xl font-bold text-center text-lg shadow-[0_8px_20px_rgba(0,0,0,0.1)] hover:bg-gray-50 transition-all transform active:scale-95 flex items-center justify-center gap-2 border border-transparent">
            Daftar Akun Baru
        </a>
